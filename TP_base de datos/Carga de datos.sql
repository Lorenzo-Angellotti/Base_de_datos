...
(sku, nombre, descripcion, id_categoria, tamano, precio, stock, peso_gramos, alto_cm, ancho_cm, largo_cm, imagen) 
VALUES
('ESC-VAN-100', 'Esencia de Vainilla', 'Esencia aromática para velas.', 1, '100 ml', 3500, 20, 100, 12, 5, 5, 'vainilla.jpg'),
('ESC-LAV-100', 'Esencia de Lavanda', 'Esencia relajante para velas.', 1, '100 ml', 3700, 15, 100, 12, 5, 5, 'lavanda.jpg'),
('ESC-COC-250', 'Esencia de Coco', 'Esencia tropical para velas.', 1, '250 ml', 7200, 8, 250, 18, 7, 7, 'coco.jpg'),
('CER-SOJ-1KG', 'Cera de Soja', 'Cera vegetal para elaboración de velas.', 3, '1 kg', 6200, 25, 1000, 20, 15, 8, 'cera_soja.jpg'),
('CER-PAR-1KG', 'Parafina Premium', 'Parafina refinada para velas.', 3, '1 kg', 5400, 12, 1000, 20, 15, 8, 'parafina.jpg'),
('PAB-ALG-10M', 'Pabilo de Algodón', 'Rollo de pabilo para velas.', 2, '10 metros', 2500, 30, 80, 10, 8, 4, 'pabilo.jpg'),
('ENV-VAS-200', 'Vaso de Vidrio 200 ml', 'Envase de vidrio para vela aromática.', 4, '200 ml', 1800, 50, 200, 9, 7, 7, 'vaso_vidrio.jpg'),
('ENV-LAT-150', 'Lata Metálica 150 ml', 'Lata para vela decorativa.', 4, '150 ml', 1600, 40, 150, 6, 8, 8, 'lata.jpg'),
('PER-TEX-250', 'Perfume Textil Jazmín', 'Perfume textil para ropa y ambientes.', 5, '250 ml', 4800, 10, 250, 18, 6, 6, 'perfume_textil.jpg'),
('DIF-AMB-500', 'Difusor Ambiental', 'Difusor aromático para ambientes.', 5, '500 ml', 9500, 4, 500, 22, 8, 8, 'difusor.jpg');
...
(nombre_descuento, porcentaje, fecha_inicio, fecha_fin) 
VALUES
('Promo Aromas de Invierno', 10, '2026-06-01', '2026-06-30'),
('Descuento Perfumería Fina', 15, '2026-05-01', '2026-05-31');
